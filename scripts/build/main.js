...
Game.SIDE_LENGTH = 10;
Game.DEFAULT_HOLES_NUMBER = 9;
var GameOver;
(function (GameOver) {
    GameOver[GameOver["isNotOver"] = 0] = "isNotOver";
    GameOver[GameOver["fallIntoHole"] = 1] = "fallIntoHole";
    GameOver[GameOver["burningByDragon"] = 2] = "burningByDragon";
    GameOver[GameOver["killingDragon"] = 3] = "killingDragon";
})(GameOver || (GameOver = {}));
;

var Action;
(function (Action) {
    Action[Action["walking"] = 0] = "walking";
    Action[Action["shooting"] = 1] = "shooting";
})(Action || (Action = {}));
;
...
var Content;
(function (Content) {
    Content[Content["none"] = 0] = "none";
    Content[Content["dragon"] = 1] = "dragon";
    Content[Content["hole"] = 2] = "hole";
    Content[Content["dragonWarning"] = 3] = "dragonWarning";
    Content[Content["holeWarning"] = 4] = "holeWarning";
    Content[Content["doubleWarning"] = 5] = "doubleWarning";
})(Content || (Content = {}));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Game_index__ = __webpack_require__(4);

Object(__WEBPACK_IMPORTED_MODULE_0__Game_index__["a" /* default */])();
...
function cancelButtonClick() {
    ...
    if (cancelButton != null)
        cancelButton.addEventListener("click", showMenu);
}
